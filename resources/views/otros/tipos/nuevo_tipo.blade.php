...
{{-- fin validaciones para los errores --}}
  ...
  <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Tipos <small>Crear Tipos Equipo</small></h2><br><br>
          ...
          <div class="x_content">
            ...
            <form action="{{asset('/tipos/guardar')}}" method="POST" data-parsley-validate class="form-horizontal form-label-left">
                {{ csrf_field() }}
