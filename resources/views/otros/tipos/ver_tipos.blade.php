...
@section('content')
  ...
  <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Tipos <small>Listado Tipos Equipos</small></h2><br><br>
            <a href="{{asset('/tipos/nuevo_tipo')}}" class="btn btn-primary btn-sm">Nuevo Tipo</a>
                ...
                <tbody>
                  @foreach ($tipos as $i => $tipo)
                    <tr>
                      ...
                      <td>{{$tipo->nombre}}</td>
                      <td><center><a href="{{ asset('/tipos/editar/'.$tipo->id)}}"><i class="fa fa-edit btn btn-primary btn-xs"></i></a></center></td>
                      <td><center><a data-toggle="modal" data-target="#modal-delete-{{$tipo->id}}"><i class="fa fa-trash-o btn btn-danger btn-xs "></i></a></center></td>
                    </tr>    
                    @include('otros/tipos/modal_tipos')
                  @endforeach
