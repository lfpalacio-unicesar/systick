...
@section('content')
  ...
  <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Software <small>Listado Software</small></h2><br><br>
            <a href="{{asset('/softwares/nuevo_software')}}" class="btn btn-primary btn-sm">Nuevo Software</a>
            ...
            <br/>
              ...
              <table id="datatable-buttons" class="table table-striped table-bordered">
                <thead>
                  <tr>
                    <th width="3%">#</th>
                    <th width="87%">Nombre software</th>
                ...
                <tbody>
                  @foreach ($softwares as $i => $software)
                    <tr>
                      ...
                      <td><center><a href="{{ asset('/softwares/editar/'.$software->id)}}"><i class="fa fa-edit btn btn-primary btn-xs"></i></a></center></td>
                      <td><center><a data-toggle="modal" data-target="#modal-delete-{{$software->id}}" ><i class="fa fa-trash-o btn btn-danger btn-xs "></i></a></center></td>
                    </tr>
                    @include('otros/softwares/modal_softwares')    
                  @endforeach
