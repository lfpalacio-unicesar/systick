...
@section('content')
  ...
  <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Marcas <small>Listado Marcas Equipos</small></h2><br><br>
            <a href="{{asset('/marcas/nueva_marca')}}" class="btn btn-primary btn-sm">Nueva Marca</a>
                ...
                <tbody>
                  @foreach ($marcas as $i => $marca)
                    <tr>
                      ...
                      <td>{{$marca->nombre}}</td>
                      <td><center><a href="{{ asset('/marcas/editar/'.$marca->id)}}"><i class="fa fa-edit btn btn-primary btn-xs"></i></a></center></td>
                      <td><center><a data-toggle="modal" data-target="#modal-delete-{{$marca->id}}"><i class="fa fa-trash-o btn btn-danger btn-xs "></i></a></center></td>
                    </tr>
                    @include('otros/marcas/modal_marcas')    
                  @endforeach
