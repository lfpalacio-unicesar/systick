...
@section('titulo','Sistemas Operativos')
...
@section('content')
  ...
  <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Sistemas <small>Listado Sistemas Operativos</small></h2><br><br>
            ...
            <br/>
              ...
              <table id="datatable-buttons" class="table table-striped table-bordered">
                <thead>
                  <tr>
                    <th width="3%">#</th>
                    <th width="87%">Sistema Operativo</th>
                ...
                <tbody>
                  @foreach ($sistemas as $i => $sistema)
                    <tr>
                      ...
                      <td><center><a href="{{ asset('/sistemas/editar/'.$sistema->id)}}"><i class="fa fa-edit btn btn-primary btn-xs"></i></a></center></td>
                      <td><center><a data-toggle="modal" data-target="#modal-delete-{{$sistema->id}}" ><i class="fa fa-trash-o btn btn-danger btn-xs "></i></a></center></td>
                    </tr>
                    @include('otros/sistemas/modal_sistemas')    
                  @endforeach
