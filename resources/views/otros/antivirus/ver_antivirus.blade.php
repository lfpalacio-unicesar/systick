 ...
 {{-- mensaje de error eliminacion de registro --}}
  ...
  <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Antivirus <small>Listado Antivirus</small></h2><br><br>
            <a href="{{asset('/antivirus/nuevo_antivirus')}}" class="btn btn-primary btn-sm">Nuevo Antivirus</a>
            ...
            <br/>
              ...
              <table id="datatable-buttons" class="table table-striped table-bordered">
                <thead>
                  <tr>
                    <th width="3%">#</th>
                    <th width="87%">Antivirus</th>
                    <th width="5%"><center>Editar</center></th>
                    <th width="5%"><center>Eliminar</center></th>
                  </tr>
                </thead>
                <tbody>
                  @foreach ($anti as $i => $item)
                    <tr>
                      <td><center>{{$i+1}}</center></td>
                      <td>{{$item->nombre}}</td>
                      <td><center><a href="{{ asset('/antivirus/editar/'.$item->id)}}"><i class="fa fa-edit btn btn-primary btn-xs"></i></a></center></td>
                      <td><center><a data-toggle="modal" data-target="#modal-delete-{{$item->id}}"><i class="fa fa-trash-o btn btn-danger btn-xs "></i></a></center></td>
                    </tr>
                    @include('otros/antivirus/modal_antivirus')    
                  @endforeach
