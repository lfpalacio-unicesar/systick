...
{{-- fin validaciones para los errores --}}
  ...
  <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Servicios <small>Editar Servicios</small></h2><br><br>
          ...
          <div class="x_content">
            ...
            <form action="{{asset('/servicios/actualizar')}}" method="POST" data-parsley-validate class="form-horizontal form-label-left">
                {{ csrf_field() }}
                <div class="form-group">
                    ...
                    <input type="text" id="nombre" name="nombre" required="required" class="form-control col-md-7 col-xs-12" value="{{$servicio->nombre}}">
                    </div>
                </div>               
