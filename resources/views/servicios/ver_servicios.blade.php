...
@section('content')
  ...
  @endif
  {{-- mensaje de error eliminación de servicios base --}}
  @if (session('status3'))
    <div class="alert alert-danger">
      <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>
        {!! session('status3') !!}
  ...
  <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Servicios <small>Listado Servicios</small></h2><br><br>
            <a href="{{asset('/servicios/nuevo_servicio')}}" class="btn btn-primary btn-sm">Nuevo Servicio</a>
            ...
            <br/>
              ...
              <table id="datatable-buttons" class="table table-striped table-bordered">
                <thead>
                  <tr>
                    <th width="3%">#</th>
                    <th width="87%">Nombre servicio</th>
                ...
                <tbody>
                  @foreach ($servicios as $i => $servicio)
                    <tr>
                      ...
                      <td><center><a href="{{ asset('/servicios/editar/'.$servicio->id)}}"><i class="fa fa-edit btn btn-primary btn-xs"></i></a></center></td>
                      <td><center><a data-toggle="modal" data-target="#modal-delete-{{$servicio->id}}"><i class="fa fa-trash-o btn btn-danger btn-xs "></i></a></center></td>
                    </tr>
                    @include('servicios/modal_servicios')    
                  @endforeach
